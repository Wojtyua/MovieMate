 ...
 *
 * Side-effect-free: inputs (one-or-two tastes, session prefs, TMDB candidates)
 * in, up to three role-labeled picks out. No I/O, no env, no TMDB/Supabase — the
...
export { WEIGHTS, type Taste, type SessionPrefs } from "@/lib/recommend/scoring";
